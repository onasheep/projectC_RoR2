...
public class Lemurian : MoveMove
{
    public enum STATE
    {
        NONE, CREATE, RUN, BATTLE, DEAD
    }
    AIPerceptionlemu _aiperception = null;
    ...
    AIPerceptionlemu myperceptions
    {
        get
        {
            if (_aiperception == null)
            {
                _aiperception = this.GetComponentInChildren<AIPerceptionlemu>();
